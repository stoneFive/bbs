...
<body style="">
    ...
    <div class="row" style="margin-top: 10px;">
        <h4 style="margin-left: 30px;margin-top: 0px;">动态管理</h4>
        ...
        <table class="layui-table" lay-skin="line">
            ...
            <c:forEach items="${page.content}" var="entity">
                <tr>
                    ...
                    <td> <a class="layui-btn layui-btn-small" href="${ctx}trends/del.html?id=${entity.id}"  >删除 </a>&nbsp;
                       <a class="layui-btn layui-btn-small" href="${ctx}trends/edit.html?id=${entity.id}"  >修改 </a> &nbsp;
                   </td>
